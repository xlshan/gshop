  ...
  <div class="shop-header">
    ...
    <div class="shop-content" @click="toggleShopShow">
      ...
      <div class="header-content">
        <h2 class="content-title">
          ...
          <span class="content-name">222</span>
          <i class="content-icon"></i>
        </h2>
        <div class="shop-message">
          <span class="shop-message-detail">1</span>
          <span class="shop-message-detail">月售1单</span>
          <span class="shop-message-detail">
           22222
            <span>约33分钟</span>
          </span>
          <span class="shop-message-detail">距离222</span>
        </div>
      </div>
    </div>
    ...
    <div class="shop-header-discounts"  @click="toggleSupportShow">
      <div class="discounts-left">
        <div class="activity">
          <span class="content-tag">
            <span class="mini-tag">2</span>
          </span>
          <span class="activity-content ellipsis">啦啦啦啦啦啦啦啦绿绿</span>
        </div>
      </div>
